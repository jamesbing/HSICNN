...
#    early_stopping = EarlyStopping(monitor='val_loss',patience=30,verbos = 1, mode='min')
...
#    layer4 = Activation('tanh')
    ...
    #the optimizer
    sgd = SGD(lr = learning_ratio, decay = train_decay, momentum = 0.8, nesterov=True)
...
#    print(train_dataset_data)
    ...
    history = model.fit(train_dataset_data, train_dataset_label, batch_size = 20, nb_epoch = 500, verbose=1, validation_split=0, shuffle=True)
...
if __name__ == '__main__':
    network("newIndian50percentN.mat",1,40)
#    temp_network("newPU1NWith2RestN.mat", number_of_con_filters = 20, con_step_length = 1, max_pooling_feature_map_size = 40, number_of_full_layer_nodes = 120, learning_ratio = 0.01, train_decay = 0.001)
